...
const Page = () => {
  return (
    <div className="relative min-h-[750px] w-full flex flex-col items-center justify-center p-5">
      ...
      <section className="relative text-white m-10 bg-black/70 border border-orange-400 w-full rounded-lg p-6 sm:w-[500px] flex flex-col items-start justify-center z-10">

...
const Page = () => {
  ...
  <section className="relative text-white m-10 bg-black/50 border border-orange-400 w-full rounded-lg p-10 sm:w-[500px] flex flex-col items-start justify-center z-10">

...
const Books = () => {
  ...
  return (
    <div className="relative min-h-[750px] w-full flex flex-col items-center justify-center">
      ...
      <section className="relative text-white m-10 bg-black/70 border border-orange-400 rounded-lg p-2 sm:w-[500px] flex flex-col items-start justify-center z-10 transition-all duration-500">
        <Image
          src={book.image}
          alt={book.title}
          width={1000}
        ...
        />
        <h2 className="text-2xl font-bold text-orange-400 mx-auto p-3">{book.title}</h2>
        <section className="px-7 w-full">
          ...
          <Link href={book.link}>
            <button className="text-lg mt-5 bg-orange-400 px-4 py-2 mb-2 rounded-md font-bold cursor-pointer text-black w-full">
              Till boken →
            </button>
          </Link>
        </section>
